...
export default function OwnerProfitsScreen({ view = "profits", onNavigate, onLoggedOut, unreadNotifications = 0, onSyncNow, syncing = false, syncMessage = "" }) {
  ...
  return (
    <View style={styles.page}>
      <Sidebar active={view} onNavigate={onNavigate} showProfits unreadNotifications={unreadNotifications} onSyncNow={onSyncNow} syncing={syncing} syncMessage={syncMessage} onLogout={async () => { await ownerLogout(); onLoggedOut(); }} />
